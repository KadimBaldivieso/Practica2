...
using CancionesWebApi2.Models;

namespace CancionesWebApi2.Controllers
{
    ...
    public class CancionesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Cancion>> PostCancion(Cancion cancion)
        {
            ...
            {
                if (CancionExists(cancion.Autor))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCancion", new { id = cancion.Autor }, cancion);
        }
        ...
        {
            return _context.Cancion.Any(e => e.Autor == id);
        }
    }
}
